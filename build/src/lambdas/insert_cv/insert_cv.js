...
const lambda_helpers_1 = require("../../utils/lambda_helpers");
...
const handler = (event, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield mongoose_1.default
        ...
        try {
            ...
            Object.values(data['cv_object']['work']).forEach((elements) => {
            ...
            const cv = yield CV_1.default.create(data['cv_object']);
            console.log(cv);
            console.log('good');
            yield User_1.default.findOneAndUpdate({ email: data['user'] }, { $set: { cv: cv._id, cv_uploaded: true } });
            return {
                statusCode: 200,
                body: JSON.stringify({
                    message: 'all good'
